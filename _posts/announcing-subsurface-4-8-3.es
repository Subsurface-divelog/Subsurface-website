---
ID: 4250
post_title: Announcing Subsurface 4.8.3
author: hohndel
...
<ul>
	<li>Desktop: enable GPU switching on macOS</li>
	<li>Dive media: rudimentary support for XMP metadata</li>
	<li>Desktop: remember up to four dive computers that have been used to download dives and provide easy shortcut buttons to switch between them</li>
	<li>Dive computer support:
<ul>
	<li>add support for Mares BlueLink Pro based BLE download</li>
	<li>add support for Aqualung i100</li>
	<li>Garmin Descent Mk1: allow import of FIT files downloaded from Garmin Connect</li>
	<li>fix bug in Shearwater Teric support</li>
</ul></ul>
