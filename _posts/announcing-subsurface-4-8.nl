...
<ul>
	 ...
	 <li>CSV import: sta newline ('n') toe in notities veld</li>
...
Je kunt Subsurface 4.8 ophalen van de volgende locaties:
  ...
  <code>chmod +x Subsurface-4.8.0-x86_64.AppImage</code> en voer dan eenvoudig dit bestand uit.
...
Zoals met de desktop versie: post vragen of problemen op het <a href="https://subsurface-divelog.org/nl/user-forum-nl/">User Forum</a> of rapporteer een fout in onze <a href="https://github.com/Subsurface-divelog/subsurface/issues">Bug Tracker</a>.
