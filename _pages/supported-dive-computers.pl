...
Lista obsługiwanych komputerów nurkowych (poprzez bibliotekę libdivecomputer) - stan na kwiecień 2019.
...
<dl><dt>Aeris</dt><dd><ul>
    ...
    <dt>Shearwater</dt><dd><ul>
	    <li>Nerd, Nerd 2, Perdix, Perdix AI, Petrel, Petrel 2, Predator, Teric</li></ul>
    </dd>
