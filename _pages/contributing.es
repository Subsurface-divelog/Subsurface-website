...
<p>Podría ser una buena idea unirse a nuestra <a href="http://lists.subsurface-divelog.org/cgi-bin/mailman/listinfo/subsurface">lista de correo</a>.<br>
La conversación aquí es en inglés, incluso aunque esta web y el propio Subsurface estén disponibles en muchos lenguajes, la lengua en la que todos nos comunicamos es el inglés. En realidad basta con un "inglés chapurreado" ... :-)</p>
<p>También suele haber algunos desarrolladores en el canal <code>#subsurface</code> en <a href="http://freenode.net/">Freenode</a>.</p>
<p>Hay muchas maneras en las que puedes contribuir. Siempre andamos buscando "testers" que deseen probar el código mientras se está desarrollando.  Necesitamos especialmente personas que utilicen Windows y Mac (al ser la mayoría de los desarrolladores gente de Linux). También andamos siempre buscando voluntarios que ayuden revisando y mejorando la documentación.  Y, muy importante, buscamos traductores dispuestos a traducir el software a diferentes lenguajes. Nuestras traducciones se manejan centralizadamente en <a href="https://www.transifex.com/">Transifex</a>; por favor, registra una cuenta allí y luego solicita unirte al <a href="https://www.transifex.com/projects/p/subsurface/">equipo de Subsurface</a>.</p>
<p>Si quisieras contribuir con parches que corrijan errores o añadan nuevas prestaciones, eso sería especialmente bienvenido. A continuación una pequeña introducción acerca de crear "commits" que puedas enviar a la lista de correo. Se pueden encontrar muchos más detalles sobre el uso de "git" en el <a href="https://www.kernel.org/pub/software/scm/git/docs/user-manual.html">manual de usuario de git</a>.</p>
<p>Empieza por conseguir las últimas fuentes (mira en la página <a href="https://subsurface-divelog.org/building/">Compilar</a> para ver como).<br>
<code>cd subsurface<br>
git checkout master<br>
git pull</code><br>
Ok, ahora estamos en la última versión. Crea una rama de trabajo para conservar allí tu desarrollo:<br>
...
<code>El cuerpo del mensaje son unas pocas líneas de texto, explicando<br>
las cosas con más detalle, posiblemente dando alguna información<br>
...
<p><code>Reported-by: whoever-reported-it<br>
Signed-off-by: Your Name</code></p>
<p>La línea de cabecera debe ser muy significativa, y <b>realmente</b> debe ser una única linea. La línea de encabezamiento es lo que muestran herramientas como gitk y shortlog, y debe resumir el cambio en una línea de texto legible, independientemente de la explicación, que será más amplia.</p>
