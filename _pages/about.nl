...
<h2>Onze nieuwste versie is uitgebracht</h2>
Kijk op <a href="https://subsurface-divelog.org/nl/2018/11/announcing-subsurface-4-8-4/">de aankondiging van Subsurface 4.8.4</a> voor de details.
...
Subsurface kan <strong>plannen</strong> en <strong>werken</strong> met één of meer cilinders met lucht, nitrox of trimix. Duiklocaties kunnen worden beschreven met onder meer de GPS locaties (die ook gemakkelijk via een kaart kunnen worden ingevoerd), gebruikte apparatuur, buddy's, een waardering van de duik en extra aantekeningen.

Je kunt duiken labelen en <strong>een duiklijst filteren</strong> op basis van criteria, waaronder labels, locaties en buddy's. Je kunt duiken groeperen in (bijvoorbeeld) reizen, en meerdere duiken tegelijkertijd bewerken, waardoor het gemakkelijk is om een groot aantal duiken bij te houden.
...
Subsurface berekent ook een breed scala aan <strong>statistieken</strong> van de duiken van de gebruiker en berekent allerlei gegevens, zoals de SAC verbruik, partiële O2-, N2- en He-drukken, berekende deco-informatie, en nog veel meer.


  <strong>Meerdere duikers</strong> kunnen één installatie van Subsurface gebruiken met verschillende voorkeuren en instellingen.

Het programma is vertaald in ongeveer <strong>20 talen</strong>, en wordt goed ondersteund door een actieve groep ontwikkelaars.
...
Een van de belangrijkste troeven van Subsurface is de ondersteuning van een breed scala aan <strong>duik computers</strong> (zie de lijst van <a href="documentation/supported-dive-computers/">Ondersteunde computers</a>). Subsurface kan ook bestaande duiklogboeken importeren uit diverse bronnen, waaronder MacDive, Suunto DM3, DM4 &amp; DM5, JDiveLog en divelogs.de.

Een ander sterk punt is de <strong>visualisatie</strong> van het diepteprofiel (en, indien beschikbaar, de tankdruk grafiek) op innovatieve manieren die de gebruiker aanvullende informatie over de relatieve snelheid en kortstondige luchtverbruik geeft. Gebruikers die met <strong>meerdere duikcomputers</strong> duiken kunnen de gegevens uit elk van hun duikcomputers combineren in één profiel.
...
Subsurface kan een gedetailleerd logboek <strong>afdrukken</strong> met duikprofielen en andere belangrijke informatie.
