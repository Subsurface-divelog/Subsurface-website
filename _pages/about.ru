...
Ознакомьтесь с <a href="https://subsurface-divelog.org/ru/2018/07/announcing-subsurface-4-8-1/">анонсом версии Subsurface 4.8.1</a>.
...
С помощью Subsurface на Android и iOS вы получаете доступ к вашему журналу погружений где бы вы не находились
...
Subsurface позволяет <strong>планировать</strong> и <strong>регистрировать</strong>
  <strong>погружения</strong> с одним или несколькими баллонами, используя воздух, нитрокс или тримикс; отслеживает места погружений, включая GPS-координаты (их можно ввести с помощью карты);учитывает конфигурацию оборудования, имена напарников и другие детали погружений.

Вы можете расставлять метки и <strong>фильтровать</strong> погружения, используя эти метки, дайв-сайты и имена людей, с которыми вы ныряли. Мы можете группировать погружения в поездки и выполнять множественное редактирование, что очень удобно при большом количестве погружений.
...
Subsurface рассчитывает различную <strong>статистику</strong> погружений и ведет учет уровня SAC, парциальных давлений O2, N2 и He, деко-обязательств и много чего еще.
  ...
  <strong>Несколько пользователей</strong> могут работать с Subsurface не мешая друг другу, и использовать при этом собственные настройки приложения.
...
Одной из самых сильных сторон Subsurface является <strong>поддержка большинства дайв-компьютеров</strong> (см. <a href="documentation/supported-dive-computers/">список поддерживаемых устройств</a>). Subsurface может также импортировать журналы погружений из других источников, включая MacDive, Suunto DM3, DM4 и DM5, JDiveLog и divelogs.de.

Другое преимущество— инновационная <strong>визуализация</strong> профиля погружения с отображением относительной скорости и расхода газов (и, если доступно, давления в баллонах) во время погружения. Вы можете комбинировать информацию из <strong>нескольких дайв-компьютерами</strong> в одном погружении и просматривать её на профиле погружения.
