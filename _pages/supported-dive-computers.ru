...
Ниже приведен список поддерживаемых дайв-компьютеров (с помощью libdivecomputer) в версии 4.6 Beta 2 (Январь 2017).
...
Subsurface также поддерживает чтение XML файлов, которые экспортируются из
<ul>
